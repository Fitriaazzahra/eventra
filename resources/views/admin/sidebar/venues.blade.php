                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="eventra-row-actions">
                                            ...
                                            <form method="POST" action="{{ route('admin.venues.destroy', ['locale' => app()->getLocale(), 'venue' => $venue->id]) }}" onsubmit="return confirm('{{ app()->getLocale() === 'id' ? 'Yakin ingin menghapus venue ini?' : 'Are you sure you want to delete this venue?' }}');">
                                                @csrf
                                                @method('DELETE')
